...
def _delvewheel_patch_1_12_0():
    import os
    if os.path.isdir(libs_dir := os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, 'gudhi.libs'))):
...
__debug_info__ =     "Python version 3.12.10\n" \
    "Nanobind version 2.12.0 \n" \
    "Numpy version 2.4.4 \n" \
    "Eigen3 version 5.0.1\n" \
    "Boost version 1.90.0\n" \
    "CGAL version 6.1.1\n" \
    "GMP_LIBRARIES = C:/vcpkg/installed/x64-windows/debug/lib/gmp.lib\n" \
    "GMPXX_LIBRARIES = C:/vcpkg/installed/x64-windows/debug/lib/gmpxx.lib\n" \
    "MPFR_LIBRARIES = C:/vcpkg/installed/x64-windows/debug/lib/mpfr.lib\n" \
